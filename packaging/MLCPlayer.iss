...
begin
  ...
  if CurrentInstallMode = InstallModeReinstall then
    Body := FmtMessage(CustomMessage('CWelcomeReinstallBody'),
      ['{#MyAppVersion}'])
  else if CurrentInstallMode = InstallModeUpgrade then
    Body := FmtMessage(CustomMessage('CWelcomeUpgradeBody'),
      [InstalledVersionText, '{#MyAppVersion}'])
  else
    Body := FmtMessage(CustomMessage('CWelcomeInstallBody'),
      ['{#MyAppVersion}']);
...
begin
  ...
  PreferencesInfoLabel.Caption := CustomMessage('COpenWithInfo') +
    #13#10#13#10 + CustomMessage('CPrivacyInfo') + #13#10#13#10 +
  ...
  case CurPageID of
    ...
    wpFinished:
      begin
        ...
        WizardForm.FinishedLabel.Caption := CustomMessage('CFinishBody') +
          #13#10#13#10 + CustomMessage('CFinishDescription');
