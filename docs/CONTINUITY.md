...
- Kayıt hazırlanırken doğrulanan HEAD: `59f6980d6be88d5c66ab55aeb235a1e07518e212`
...
- Dal: `master` (`origin/master` ile `0/0`; UX/lifecycle düzeltmeleri ve kanıt kaydı uncommitted)
- Son kanıt: `EV-20260828-037`
...
Kullanıcının ayrı onayıyla gerçek Windows tıklamalı UX kabulünü exact diff üzerinde yürüt; ardından kullanıcı tek-agent kısıtını kaldırırsa bağımsız karşıt inceleme al. Bu iki kapı geçmeden formal GO veya commit isteme. Build, native/kurulu artifact ve fiziksel kurulum ayrı onaylıdır.
